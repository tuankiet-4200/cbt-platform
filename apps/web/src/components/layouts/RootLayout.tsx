...
import { BookOpen, BarChart3, User, LogOut, Shield, ChevronRight, GraduationCap, Inbox, Tags, FileJson, History, Dumbbell } from 'lucide-react';
...
const userNavItems = [
  ...
  { to: '/practice',  label: 'Luyện theo chủ đề', icon: Dumbbell },
